...
const AdminDelete = () => {
  ...
  return (
    <div className="algo-delete-page">
      <style>{`
        .algo-delete-page {
          --void: #0a0e14;
          --surface: #121826;
      ...
      <div className="algo-hero">
        ...
        <div className="algo-hero__inner">
          <p className="algo-hero__eyebrow">Destructive action</p>
          <h1 className="algo-hero__title">
            Delete<span>_Problem</span>
          </h1>
          <p className="algo-hero__subtitle">
            {problems.length} problem{problems.length === 1 ? '' : 's'} — this action cannot be undone.
          </p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="algo-list">
            {problems.map((problem, index) => (
              <div
                key={problem._id}
                className={`algo-row ${deletingId === problem._id ? 'is-deleting' : ''}`}
